document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchProfileData() {
        try {
            const response = await fetch('/spiceheritage/customer/my-profile');
            if (!response.ok) {
    ...
    async function handleProfileUpdate(e) {
        e.preventDefault();
        const response = await fetch('/spiceheritage/update-profile', {
            method: 'POST',
    ...
    async function handleAddressUpdate(e) {
        e.preventDefault();
        const response = await fetch('/spiceheritage/address-manager', {
            method: 'POST',
            body: new URLSearchParams(new FormData(e.target))
        });
    ...
    async function deleteAddress(addressId) {
        ...
        const response = await fetch(`/spiceheritage/address-manager?id=${addressId}`, {
            method: 'DELETE'
        });
        const result = await response.json();
        if (result.success) {
